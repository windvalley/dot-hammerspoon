...
function _M.run()
	...
	assert_close(find_element(direct_recorded.canvas_states[1].elements, "arrow_fill").coordinates[2].x, 160, 0.0001, "translator should aim the popup arrow at the selection center")
	assert_close(find_element(direct_recorded.canvas_states[1].elements, "arrow_fill").coordinates[2].y, 139.5, 0.0001, "translator should place the arrow tip on the lower edge when the popup is above the selection")
