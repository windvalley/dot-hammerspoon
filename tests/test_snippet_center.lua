...
function _M.run()
	...
	assert_true(find_menu_item(menubar_menu, "打开: ⌥ ⇧ S") ~= nil, "menubar should display the chooser hotkey")
	assert_true(find_menu_item(menubar_menu, "保存: ⌥ ⌘ ⇧ S") ~= nil, "menubar should display the quick save hotkey")
	...
	assert_true(find_menu_item(snippet_menu_item.menu, "First snippet ↩ Line two") == nil, "snippet submenu should not duplicate the body preview as a wide header row")
	assert_contains(snippet_menu_item.tooltip, "First snippet ↩ Line two", "snippet menubar item should keep the full preview in its tooltip")
	...
	assert_true(find_menu_item(menubar_menu, "打开: ⌃ ⌥ K") ~= nil, "menubar should refresh the chooser hotkey label after reconfiguration")
	assert_true(find_menu_item(menubar_menu, "保存: ⌘ ⇧ J") ~= nil, "menubar should refresh the quick save hotkey label after reconfiguration")
	auto_paste_item.fn()
